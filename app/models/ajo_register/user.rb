module AjoRegister
  class User < ActiveRecord::Base
    ...
    attr_accessible :password, :password_confirmation, :remember_me, :source, :facebook_id, :age_of_consent, :city, :email, :first_name, :gender, :last_name, :mailing_address, :optin, :opt_in_confirmed, :province, :rules_and_regulations, :password, :password_confirmation, :date_of_birth
